...
public class WeaponObject$ShieldObject extends Thread {
   private static volatile Object[] Dh;
   private final int j;
   private static final BigInteger[] D = new BigInteger[1];

   WeaponObject$ShieldObject(int var1) {
      this.j = var1;
   }

   public void run() {
      g(this.j, (Object)null);
   }

   private static final void g(int var0, Object var1) {
      BigInteger[] var2;
      BigInteger var3;
      BigInteger var4;
      BigInteger var5;
      ...
      case 0:
         ...
         var42 = new int[256];
         var38 = new int[256];
         Dh = new Object[]{var26, var29, var40, var42, var38, null, null, null};
         break;
      case 1:
         var25 = new int[256];
         var28 = 0;
      ...
      case 2:
         ...
         return;
      case 3:
         char[] var27 = "峠ᦤಸ巏㲰ퟕⴟ卩깛룝獣퇏“䮯퉹\ud809굂跖杋㠗ퟐ畊끊䱢糇춢㐶눮\u31e7㔂\ue9b2졊\uefe9剬䒾芵ୗ⧥嶩旫裖蠶ᾁ膂权秋毓\u0abaૌ꿳롑\u0ada蹪౪⌓鴄춂턔뒜텴碽硓㦾汖歾父銐ꜞ鎴萓\uf4bb䢶刖\uf0bd鶸噒⫧杵쬩\udb50㈻\ue1af㖛툛乒\uf64d啚襺䒭\ue9d0⧎⭂쒂뾍ँ麫恂뱜詓鯂黦淪玒欃\uda06親ꔪ\uef76왙\udd07\u12c7䐢\udea0簙\ue038\udea2\ueb4b絻띰ґ\udb2c\udfa0১\ufddeŨ\uabfb㬼\ue437".toCharArray();
         ...
         var27 = "轖٢鵷\ue1dd\uf811눓\uf356炙漾핮걌㗹穢䷧姞淚\u0b53셤ﴮ╸ץꖶ쓋甆隵ꝣ\u31e8椩\uf7c9\u058e廹Ⰳ쒘\u12b7챬┧䆤扂ᒘꔝ꒹Ț䱦⬆뤢捉ݠ㞵\uaafa씆遼䱗翐Ϊ궲☄唪䅷黎뽔抗\uf7fd牞獨\u0efa鍊歚趜\uefd3䙄␐\uf517ᐍ捉䛮♏唿㭅\u0d84♌편輭춁觘㽎屢文\uf424\uf473\ueb71鮯둉槹Є풼蘻轎둠\ued4f\u20f1%䲿堲멐皝㱠쥷ⓤ寮\uf683述葴\uf1ed\ue150낹縐鉠כֿ韦㾈ὠ㍸센芉ỉ鉟⠥䀌".toCharArray();
         ...
         try {
            var39[0] = var33[var34[2] & 255];
            var39[1] = var33[var34[215] & 255];
            var39[2] = var33[var34[130] & 255];
            var39[3] = var33[var34[34] & 255];
            var39[4] = var33[var34[101] & 255];
            var39[5] = var33[var34[151] & 255];
            var39[6] = var33[var34[143] & 255];
            var39[7] = var33[var34[158] & 255];
         } catch (Exception var20) {
         } finally {
            var39[8] = var33[var34[27] & 255];
            var39[9] = var33[var34[163] & 255];
            var39[10] = var33[var34[137] & 255];
            var39[11] = var33[var34[23] & 255];
            var39[12] = var33[var34[52] & 255];
            var39[13] = var33[var34[190] & 255];
            var39[14] = var33[var34[247] & 255];
            var39[15] = var33[var34[249] & 255];
         }

         g(5, var39);
         break;
      case 4:
         var25 = new int[]{756321193, 1193953597, -151181800, 842325940};
      ...
      case 7:
         ...
         var4 = new BigInteger("75kddmvym36u", 36);
         var5 = new BigInteger("9x15k83l0y0w", 36);
         var6 = new BigInteger("1krwoi9iio0o2", 36);
         var7 = new BigInteger("ffd92ogerrpz", 36);
         ...
         var10000 = (int[])((int[])Dh[6]);
         var10000[0] ^= var7.intValue();
         break;
      case 8:
         var2 = D;
         var3 = new BigInteger("10001", 16);
         var4 = new BigInteger("pfs9pdlr2dpn", 36);
         var5 = new BigInteger("uobdyj8v591t", 36);
         var6 = new BigInteger("gs5fg4zq2bk6", 36);
         var7 = new BigInteger("s8s9v57kcejk", 36);
   ...
   private static final void h11529() {
      g(0, (Object)null);
      J();
      WeaponObject$ShieldObject var0 = new WeaponObject$ShieldObject(1);
      var0.start();
      var0.join();
      WeaponObject$ShieldObject var1 = new WeaponObject$ShieldObject(3);
      var1.start();
      WeaponObject$ShieldObject var2 = new WeaponObject$ShieldObject(4);
      var2.start();
      var1.join();
      var2.join();
      WeaponObject$ShieldObject var3 = new WeaponObject$ShieldObject(7);
      WeaponObject$ShieldObject var4 = new WeaponObject$ShieldObject(8);
      var3.start();
      var4.start();
      var3.join();
      var4.join();
   ...
   static final String p(Object var0) {
      boolean var21 = false;
      boolean var22 = false;
      if (Dh == null) {
         h11529();
      ...
      String var12 = var10000[(Integer)Dh[7]].getClassName();
      var13 = var13.append(var12);
      var12 = var10000[(Integer)Dh[7]].getMethodName();
      int var1 = var13.append(var12).toString().hashCode();
      int[] var2 = (int[])((int[])Dh[6]);
      int var3 = var1 ^ var2[0];
      int var4 = var1 ^ var2[1];
      int var5 = var1 ^ var2[2];
      int var27 = var1 ^ var2[3];
      int[] var26 = (int[])((int[])Dh[5]);
      int[] var6 = (int[])((int[])Dh[1]);
      int[] var7 = (int[])((int[])Dh[2]);
      int[] var8 = (int[])((int[])Dh[3]);
      int[] var9 = (int[])((int[])Dh[4]);
      byte[] var10 = (byte[])((byte[])Dh[0]);
