package ru.catssoftware.fakes.ai.individualbehavior.warriors.archers;

import ru.catssoftware.fakes.abstracts.PhantomDefaultAI;
import ru.catssoftware.fakes.ai.tasks.battle.ArcherTask;
...
public class Saggittarius extends PhantomDefaultAI {
   ...
   public void startAITask(long delay) {
      this.startAITask(new ArcherTask(this.getActor()), delay);
   }
