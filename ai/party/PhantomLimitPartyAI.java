...
public class PhantomLimitPartyAI extends PhantomPartyObject {
   public PhantomLimitPartyAI(StatsSet set) {
      super(set);
   }
   ...
   public void doBattleAction() {
      try {
         ...
         _log.error(PhantomMagePartyAI$PhantomStopPartyAI.um("뇀斀翐榖ޝ㈯\uf1f5\uda54魪㛲鹏馨ａ殮䗱彘칾暑斖⻢ퟻ틅ᆬ輥毞Ⓑ\uf88f\uece1ꜝ괟㴕譎㻵ꤋ"));
      }
