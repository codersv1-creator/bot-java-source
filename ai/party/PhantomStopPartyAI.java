...
public class PhantomStopPartyAI extends PhantomPartyObject {
   public PhantomStopPartyAI(StatsSet set) {
      super(set);
   }
   ...
   public void doBattleAction() {
      try {
         ...
         _log.error(PhantomMagePartyAI$PhantomStopPartyAI.um("⻉\ue8d4⡘ꜘ\ue99f䐽栒ආ雍䳼輁率葒ᘟＳ\u1c89浗郢䶱䄎ỿ鸼齶㚸㔛ό铸\ue706땾ᴞ\udcd0䵝茱"));
      }
