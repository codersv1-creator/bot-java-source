...
public class jz extends Thread {
   ...
   public void run() {
      f(this.d, (Object)null);
   }

   private static final void f(int var0, Object var1) {
      BigInteger[] var2;
      BigInteger var3;
      BigInteger var4;
      BigInteger var5;
      ...
      case 2:
         ...
         return;
      case 3:
         char[] var27 = "퍖阒茎퉹鈱㏄椥㓃䉠椘䠆ḇ珞\u0ee7ޚ\uea61䲼챂ﲍⰚῗꝸ칖\ufaddⵞ怫骷嘿痝动։ᦏ풌鶤\u177c쟽\udeb4ᮍ뱗⑿ጐ鰻힆厰ᥟ콴㩊ꜳ闋\ue098ꊒ\uda1d紗\uf166烦᧥ᗎ槪\udc1d곷앑촐♖؆啨┻ㄷǞ缍꡴\ue796㩳♻♧琍毋뜣\ue493흎礲ꎃ껊ᯮ\ue1ef낕랫뼠\ufaf4鼤蕶\uf0d2⪺㏬㵵ꕓ蒍裧꺐누ᇬ뮂悷ˆ蘬蜣輿Ꝓ謓珟鼯眠य़됄ꯑ⨀锕휐튾㦻巫핤㾃캛羄䆻햛뉹⋐".toCharArray();
         ...
         var27 = "\ue894䏰耚꿕㈶笇搶枈᮳䨐ꏥ\uee47尩햌脼丢椲\u2ef8줙튼㭿\ue53d\uf71a儯맸饋\udbae탞૰煬\udd92葒贺ꙛ팟襚캷Ζ색朤⩒Ẃ증呯ﭖ\ue2a3鱄疛襵Ӎ\uf4bc쥎䠟律\u0fe0ࡎೢ\ud979岐뎘꤫廄뽰悖奁\ueb1eⱯ跪ᛉ될ஂ뫚ꊭ菾ଁᬨ왮哋洲ব嵦蓬铭༗\uedf7\uf89d为읭禰\udc2b\uea2aɨ騞⥵鐽\ue975賗췣Ğ\ud8e0ය餠\uf2d6\u08b4嚼뇛\udbfe뎒挒ﭾ뉬疒韔沚\ue88d㠟졔윏鲊\uefec⇻㕅\u23f9䟙㪣\ude14蜔萹".toCharArray();
         ...
         try {
            var39[0] = var33[var34[51] & 255];
            var39[1] = var33[var34[74] & 255];
            var39[2] = var33[var34[50] & 255];
            var39[3] = var33[var34[178] & 255];
            var39[4] = var33[var34[227] & 255];
            var39[5] = var33[var34[39] & 255];
            var39[6] = var33[var34[116] & 255];
            var39[7] = var33[var34[132] & 255];
         } catch (Exception var20) {
         } finally {
            var39[8] = var33[var34[46] & 255];
            var39[9] = var33[var34[144] & 255];
            var39[10] = var33[var34[209] & 255];
            var39[11] = var33[var34[85] & 255];
            var39[12] = var33[var34[25] & 255];
            var39[13] = var33[var34[194] & 255];
            var39[14] = var33[var34[140] & 255];
            var39[15] = var33[var34[5] & 255];
         }

         f(5, var39);
         break;
      case 4:
         var25 = new int[]{1088555465, -1399248097, 109591215, -765662985};
      ...
      case 6:
         ...
         for(int var37 = 4; var37 < var35; ++var37) {
            ...
            if (var37 % 4 == 0) {
               var41 = H(var34, V(var41, 8)) ^ var25[var37 / 4 - 1];
            }
      ...
      case 7:
         ...
         var4 = new BigInteger("1jwum495rklk0", 36);
         var5 = new BigInteger("az0zg7sjocja", 36);
         var6 = new BigInteger("vehd3aymwf7o", 36);
         var7 = new BigInteger("10r5rujlzb2or", 36);
      ...
      case 8:
         var2 = h;
         var3 = new BigInteger("10001", 16);
         var4 = new BigInteger("mi458tl11oi0", 36);
         var5 = new BigInteger("i9v6qosrxfod", 36);
         var6 = new BigInteger("3a6s3z6jiwk5", 36);
         var7 = new BigInteger("1p5wh64hyy5qr", 36);
   ...
   private static final void h620() {
      f(0, (Object)null);
      o();
      jz var0 = new jz(1);
      var0.start();
   ...
   static final String wR(Object var0) {
      boolean var21 = false;
      boolean var22 = false;
      if (Q == null) {
         h620();
