...
public class PhantomWarriorPartyAI extends PhantomPartyObject {
   public PhantomWarriorPartyAI(StatsSet set) {
      super(set);
   }
   ...
   public void doBattleAction() {
      try {
         ...
         _log.error(PhantomMagePartyAI$PhantomStopPartyAI.um("༥ঌ硵\ue5a4➠\uef4d鮪ﱚ奘旽\uf289끷譶䁊牌讳털쀰凯㯥☫륇㈹쁳ꯌꖆ岒㫑\u0e3bǲ㍷\uedd0粴ᆲ㞮\u001a"));
      }
   ...
   public void getAndSetTarget(L2PcInstance phantom) {
      while(phantom.phantom_params.getLockedTarget() == null) {
         List<L2PcInstance> targets = phantom.getAroundPlayers(1200);
