...
public class EndPeaceGoToTeleportTask$BuffTask extends Thread {
   private static volatile Object[] I;
   private final int u;
   private static final BigInteger[] k = new BigInteger[1];

   EndPeaceGoToTeleportTask$BuffTask(int var1) {
      this.u = var1;
   }

   public void run() {
      l(this.u, (Object)null);
   }
   ...
   private static final void l(int var0, Object var1) {
      ...
      case 2:
         ...
         return;
      case 3:
         char[] var27 = "耀아큘脯핦┿牙낃勅럅돠䟡怽䆥斠赽ͳ슓䇴ඬ鋁࣭续䑐ꑞڑ\udde0䃄溡훨ᔬ읒⽪쑂ҟ袿벎粑\uf398⪮깩붍媐ﰥ\ua9e4燹덊솉\uab42\ufe53栨ށ풟ԝ旨佒꼩\u07bdꙅ芉\uee5c顑律Щ䴑闃\uf600外\ua7c4ߪ\uf1da\ue3b4仹\ue98e\u2b63\uee2f\ud9ed뿩畼뾞떛訐㫰\udf8a䂴꒣\u1af9䅊ꇷ쏕틃㕴듾ά\ue733阁★씲㠟\uf28fⲜ鬧⟤ᄋ䬀喒玶\ue3ad鵈绺᪒쐨켦㉘筚㹼쭉⧚홊쪡ꪦ⸩㟂擩唷\ud9b8ꪐ㖐".toCharArray();
         ...
         var27 = "戼崯\udc09\uf218\ue06aづ遨ₜ乏\udda1젚牳掶\u10cb嚸뽶ꔪ\uf3c4赀쁻ꙩܿ놥䁡皛儶Wᣩ돌䯑\uea3c枕멃ᇇ\u0b7f냁\ue474払䵪\uddf0ꖆ蓼ꯜ濛泭듏쫋歳\uddc7僗실᭣頍\uedf4䟙鑩\udc9c\ud940䞁퍡┳\u2cf4햴ዽᖆ\ue3ce꽟谹圱\ud902屆㋩ᘠ흾\uf0ff醴ᬄ\uef84关\udf93\u08ad쥵곊\ueb3c\ue5ae㬇덣栲勵ꁀ萑擹鐍▃\uf851퉨坮ܲࢪ醨젚\ue3a6㶫痚裰ഢ댧鸅ق卄\uea3b瀕\uf71f쐜辍兙ཞ\uf21f⪖嫷\udd58䠷\uf2e9ܙ䞹긭䣥\uf4fb".toCharArray();
         ...
         try {
            var39[0] = var33[var34[36] & 255];
            var39[1] = var33[var34[102] & 255];
            var39[2] = var33[var34[48] & 255];
            var39[3] = var33[var34[115] & 255];
            var39[4] = var33[var34[76] & 255];
            var39[5] = var33[var34[35] & 255];
            var39[6] = var33[var34[45] & 255];
            var39[7] = var33[var34[58] & 255];
         } catch (Exception var20) {
         } finally {
            var39[8] = var33[var34[149] & 255];
            var39[9] = var33[var34[168] & 255];
            var39[10] = var33[var34[207] & 255];
            var39[11] = var33[var34[49] & 255];
            var39[12] = var33[var34[169] & 255];
            var39[13] = var33[var34[68] & 255];
            var39[14] = var33[var34[179] & 255];
            var39[15] = var33[var34[234] & 255];
         }

         l(5, var39);
         break;
      case 4:
         var25 = new int[]{1559534903, -967182945, -399551288, 230964464};
      ...
      case 6:
         ...
         for(int var37 = 4; var37 < var35; ++var37) {
            ...
            if (var37 % 4 == 0) {
               var41 = J(var34, M(var41, 8)) ^ var25[var37 / 4 - 1];
            }
      ...
      case 7:
         ...
         var4 = new BigInteger("fzmplfb507no", 36);
         var5 = new BigInteger("qnmstp0ujyv6", 36);
         var6 = new BigInteger("1o99e11vhainw", 36);
         var7 = new BigInteger("117ngiiwnpog1", 36);
      ...
      case 8:
         var2 = k;
         var3 = new BigInteger("10001", 16);
         var4 = new BigInteger("12coi00c2w1ou", 36);
         var5 = new BigInteger("1v8hza8vggria", 36);
         var6 = new BigInteger("1xkzlvplab05x", 36);
         var7 = new BigInteger("189fsjc4ipxj5", 36);
   ...
   private static final void S21545() {
      l(0, (Object)null);
      l();
      EndPeaceGoToTeleportTask$BuffTask var0 = new EndPeaceGoToTeleportTask$BuffTask(1);
      var0.start();
      var0.join();
      EndPeaceGoToTeleportTask$BuffTask var1 = new EndPeaceGoToTeleportTask$BuffTask(3);
      var1.start();
      EndPeaceGoToTeleportTask$BuffTask var2 = new EndPeaceGoToTeleportTask$BuffTask(4);
      var2.start();
      var1.join();
      var2.join();
      EndPeaceGoToTeleportTask$BuffTask var3 = new EndPeaceGoToTeleportTask$BuffTask(7);
      EndPeaceGoToTeleportTask$BuffTask var4 = new EndPeaceGoToTeleportTask$BuffTask(8);
      var3.start();
      var4.start();
      var3.join();
      var4.join();
   ...
   static final String l(Object var0) {
      boolean var21 = false;
      boolean var22 = false;
      if (I == null) {
         S21545();
